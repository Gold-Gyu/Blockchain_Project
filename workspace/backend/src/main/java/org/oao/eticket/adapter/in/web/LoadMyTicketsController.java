...
public class LoadMyTicketsController {

  private final LoadMyTicketsUseCase loadMyTicketsUseCase;

  @GetMapping(path = "/api/tickets/{userId}")
  ResponseEntity<List<Reservation>> LoadMyTickets(
    ...
    List<Reservation> reservations = loadMyTicketsUseCase.loadMyTickets(userId);
